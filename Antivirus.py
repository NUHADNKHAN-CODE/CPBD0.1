...
class AntivirusApp(App):
    def build(self):
        ...
        self.file_chooser = FileChooserListView(path=self.get_starting_path())
    ...
    def get_starting_path(self):
        if platform == 'win':
            # On Windows, set the initial path to the user's home directory
            return os.path.expanduser("~")
        else:
            # For other platforms, set it to the current directory
            return os.getcwd()
